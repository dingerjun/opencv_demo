...
int main(int argc, char** argv)
{
    ...
    if( intrinsic_filename )
    {
        ...
        M2 = (Mat_<double>(3,3)<< 842.25861, 0., 461.55895,
             0., 838.46926, 316.88318,
             0., 0., 1.0);
        D2 = (Mat_<double>(5,1)<< 0.27170, -0.66363, 0.02277, -0.00707, 0.00000);
        Rv = (Mat_<double>(3,1)<< 0.04034, 0.00395, -0.00853);
        Rodrigues(Rv, R);
